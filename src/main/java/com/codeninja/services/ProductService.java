...
import com.codeninja.repositories.CategoryRepository;
...
public class ProductService {
    ...
    public static ProductDto mapToDto(Product product) {
        return new ProductDto(product.getId(),
                ...
                product.getReviews().stream().map(ReviewService::mapToDto).collect(Collectors.toSet()), product.getCategory().getId());
    }
